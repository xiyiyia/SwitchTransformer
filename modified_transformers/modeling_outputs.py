...
class MoEModelOutput(ModelOutput):
    ...
    token_embed: Optional[Tuple[torch.FloatTensor]] = None
    token_aggregate_layer: Optional[Tuple[torch.FloatTensor]] = None
    fuse_emb_method: Optional[Tuple[torch.FloatTensor]] = None
    total_aggregation_time: Optional[Tuple[torch.FloatTensor]] = None
@dataclass
class MoEModelOutputWithPastAndCrossAttentions(ModelOutput):
    ...
    token_embed: Optional[Tuple[torch.FloatTensor]] = None
    token_aggregate_layer: Optional[Tuple[torch.FloatTensor]] = None
    fuse_emb_method: Optional[bool] = None
    total_aggregation_time: Optional[Tuple[torch.FloatTensor]] = None
...
class Seq2SeqMoEModelOutput(ModelOutput):
    ...
    encoder_token_embed: Optional[Tuple[torch.FloatTensor]] = None
    decoder_token_embed: Optional[Tuple[torch.FloatTensor]] = None
...
class Seq2SeqMoEOutput(ModelOutput):
    ...
    encoder_token_embed: Optional[Tuple[torch.FloatTensor]] = None
    decoder_token_embed: Optional[Tuple[torch.FloatTensor]] = None
    total_aggregation_time: Optional[List[int]] = None
